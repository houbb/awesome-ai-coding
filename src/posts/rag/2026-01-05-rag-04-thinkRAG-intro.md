...
![llm](https://github.com/wzdavid/ThinkRAG/raw/main/docs/images/Model_LLM.png)

系统将自动检测 API 和密钥是否可用，若可用则在底部用绿色文字，显示当前选择的大模型实例。

同样，系统可以自动获取 Ollama 下载的模型，用户可以在用户界面上选择所需的模型。

![Ollama](https://github.com/wzdavid/ThinkRAG/raw/main/docs/images/Model_Reranker.png)

若你已经将嵌入模型和重排模型下载到本地 localmodels 目录下。

在用户界面上，可以切换选择使用的模型，并设置重排模型的参数，比如 Top N。

![Settings_Advanced](https://github.com/wzdavid/ThinkRAG/raw/main/docs/images/Settings_Advanced.png)
...
![KB](https://github.com/wzdavid/ThinkRAG/raw/main/docs/images/KB_File.png)

点击 Browse files 按钮，选择电脑上的文件，然后点击 Load 按钮加载，此时会列出所有加载的文件。

然后，点击 Save 按钮，系统会对文件进行处理，包括文本分割和嵌入，保存到知识库中。

![save](https://github.com/wzdavid/ThinkRAG/raw/main/docs/images/KB_Web.png)

同样，你可以输入或粘贴网页 URL，获取网页信息，处理后保存到知识库中。

系统支持对知识库进行管理。

![manage](https://github.com/wzdavid/ThinkRAG/raw/main/docs/images/KB_Manage.png)
...
![query](https://github.com/wzdavid/ThinkRAG/raw/main/docs/images/Query.png)
...
![arch](https://github.com/wzdavid/ThinkRAG/raw/main/docs/images/ThinkRAG_Architecture.png)
...
%% ===== Frontend =====
Frontend["Frontend\nStreamlit or React + Vite + FastAPI"]
...
%% ===== Infrastructure =====
Infrastructure["Infrastructure\nOn premise / Cloud services & Hugging Face"]
