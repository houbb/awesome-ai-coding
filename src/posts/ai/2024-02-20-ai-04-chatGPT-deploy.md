...
- 在 Vercel 重新选择并部署，[请查看详细教程](https://github.com/ChatGPTNextWeb/NextChat/blob/main/docs/vercel-cn.md#如何新建项目)。
...
![自动更新](https://github.com/ChatGPTNextWeb/NextChat/blob/main/docs/images/enable-actions.jpg)

![启用自动更新](https://github.com/ChatGPTNextWeb/NextChat/blob/main/docs/images/enable-actions-sync.jpg)
...
> 本项目大多数配置项都通过环境变量来设置，教程：[如何修改 Vercel 环境变量](https://github.com/ChatGPTNextWeb/NextChat/blob/main/docs/vercel-cn.md)。
