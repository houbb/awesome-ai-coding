...
![](https://github.com/chatchat-space/Langchain-Chatchat/raw/master/docs/img/langchain_chatchat_0.3.0.png)
...
![实现原理图](https://github.com/chatchat-space/Langchain-Chatchat/raw/master/docs/img/langchain+chatglm.png)

从文档处理角度来看，实现流程如下：

![实现原理图2](https://github.com/chatchat-space/Langchain-Chatchat/raw/master/docs/img/langchain+chatglm2.png)
...
🧑‍💻 如果你想对本项目做出贡献，欢迎移步[开发指南](https://github.com/chatchat-space/Langchain-Chatchat/raw/master/docs/contributing/README_dev.md) 获取更多开发部署相关信息。
...
![WebUI界面](https://github.com/chatchat-space/Langchain-Chatchat/raw/master/docs/img/langchain_chatchat_webui.png)
...
1. 数据库对话配置请移步这里 [数据库对话配置说明](https://github.com/chatchat-space/Langchain-Chatchat/raw/master/docs/install/README_text2sql.md)


### 源码安装部署/开发部署

源码安装部署请参考 [开发指南](https://github.com/chatchat-space/Langchain-Chatchat/raw/master/docs/contributing/README_dev.md)
...
> [!important]
> 强烈建议: 使用 docker-compose 部署, 具体参考 [README_docker](https://github.com/chatchat-space/Langchain-Chatchat/raw/master/docs/install/README_docker.md)
