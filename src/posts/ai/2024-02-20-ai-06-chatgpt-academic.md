...
- **新界面**  
  （修改 `config.py` 中的 `LAYOUT` 选项即可实现「左右布局」和「上下布局」的切换）

  ![](https://user-images.githubusercontent.com/96192199/279702205-d81137c3-affd-4cd1-bb5e-b15610389762.gif)

  ![](https://github.com/binary-husky/gpt_academic/assets/96192199/70ff1ec5-e589-4561-a29e-b831079b37fb.gif)

---

- **所有按钮通过 `functional.py` 动态生成**  
  可随意添加自定义功能，解放剪贴板
...
- **公式双显示模式**  
  若输出包含公式，将同时显示 TeX 源码与渲染结果，便于复制与阅读
...
![](https://github.com/binary-husky/gpt_academic/assets/96192199/9fdcc391-f823-464f-9322-f8719677043b)
...
![](https://github.com/binary-husky/gpt_academic/assets/96192199/66f1b044-e9ff-4eed-9126-5d4f3668f1ed)

4. **模块化功能设计**  
   简单的接口却能支持强大的功能

   ![](https://user-images.githubusercontent.com/96192199/229288270-093643c1-0018-487a-81e6-1d7809b6e90f.png)
   ![](https://user-images.githubusercontent.com/96192199/227504931-19955f78-45cd-4d1c-adac-e71e50957915.png)

5. **译解其他开源项目**

   ![](https://user-images.githubusercontent.com/96192199/226935232-6b6a73ce-8900-4aee-93f9-733c7e6fef53.png)
   ![](https://user-images.githubusercontent.com/96192199/226969067-968a27c1-1b9c-486b-8b81-ab2de8d3f88a.png)

6. **装饰 [live2d](https://github.com/fghrsh/live2d_demo) 的小功能**  
   （默认关闭，需要修改 `config.py`）

   ![](https://user-images.githubusercontent.com/96192199/236432361-67739153-73e8-43fe-8111-b61296edabd9.png)

7. **OpenAI 图像生成**

   ![](https://github.com/binary-husky/gpt_academic/assets/96192199/bc7ab234-ad90-48a0-8d62-f703d9e74665)

8. **基于 Mermaid 的流程图 / 脑图绘制**

   ![](https://github.com/binary-husky/gpt_academic/assets/96192199/c518b82f-bd53-46e2-baf5-ad1b081c1da4)

9. **LaTeX 全文校对纠错**

   ![](https://github.com/binary-husky/gpt_academic/assets/96192199/651ccd98-02c9-4464-91e1-77a6b7d1b033)
   ⇒
   ![](https://github.com/binary-husky/gpt_academic/assets/96192199/476f66d9-7716-4537-b5c1-735372c25adb)

10. **语言 / 主题切换**

   ![](https://github.com/binary-husky/gpt_academic/assets/96192199/b6799499-b6fb-4f0c-9c8e-1b441872f4e8)
